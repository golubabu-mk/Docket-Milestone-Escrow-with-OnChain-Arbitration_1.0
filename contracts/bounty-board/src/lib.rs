...
mod registry {
    ...
    soroban_sdk::contractimport!(
        file = "../../target/wasm32v1-none/release/contributor_registry.wasm"
    );
}
...
impl BountyBoard {
    ...
    pub fn post_bounty(
        ...
        env.events().publish(
            (
                soroban_sdk::Symbol::new(&env, "bounty"),
                soroban_sdk::Symbol::new(&env, "posted"),
                id,
            ),
            (sponsor, reward),
        );
    ...
    pub fn submit_work(
        ...
        env.events().publish(
            (
                soroban_sdk::Symbol::new(&env, "bounty"),
                soroban_sdk::Symbol::new(&env, "submitted"),
                bounty_id,
            ),
            contributor,
        );
    ...
    pub fn approve_and_pay(env: Env, bounty_id: u32, sponsor: Address) -> Result<(), BoardError> {
        ...
        env.events().publish(
            (
                soroban_sdk::Symbol::new(&env, "bounty"),
                soroban_sdk::Symbol::new(&env, "paid"),
                bounty_id,
            ),
    ...
    pub fn dispute_submission(
        ...
        env.events().publish(
            (
                soroban_sdk::Symbol::new(&env, "bounty"),
                soroban_sdk::Symbol::new(&env, "disputed"),
                bounty_id,
            ),
            sponsor,
        );
